...
public class HumanIO {
   ...
   public final double THIRD_SPEED = 0.3;
   public final double THIRD_SPEED_2 = 1.0;
   ...
   public static int GROUND_VAL   =0;    //-5,0
   public static int BOT_VAL      =500;    //-3,2...500
   public static int MID_VAL      =1200;   //1,10..1200
   public static int TOP_VAL      =2000;   //3,14...2000
   public static int HUMAN_VAL    =700;    //-1,6 Guess...700
   /*TODO: *****Change above values Ben Meyers*****/
...
//            topLED  = new DigitalInput(topLEDPort);
    ...
    /*TODO: Make work*/
    public double thirdSpeed(double speed3)
    {
        if(leftJoy.getTwist() > 0)
        {
            speed3 = THIRD_SPEED;
        }
        else if(leftJoy.getTwist() < 0)
        {
            speed3 = THIRD_SPEED_2;
        }
        else if(leftJoy.getTwist() == 0)
        {
   ...
   public static boolean speedControl()
    {
        if(rightJoy.getTwist() > 0)
        {
            return false;
        } else {
            return true;
